...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 11-Jun-2026 às 23:10
...
--
-- Extraindo dados da tabela `init_jogo`
--
...
INSERT INTO `respostas` (`id_resp`, `id_perg`, `id_init_jogo`, `texto_resposta`, `valor`) VALUES
-- Respostas para a Pergunta 11
(41, 11, 3, 'Cristiano Ronaldo', 10),
(42, 11, 3, 'Eusébio', 0),
(43, 11, 3, 'Pauleta', 0),
(44, 11, 3, 'Luís Figo', 0),

-- Respostas para a Pergunta 12
(45, 12, 3, '2004', 0),
(46, 12, 3, '2012', 0),
(47, 12, 3, '2016', 10),
(48, 12, 3, '2020', 0),
...
--
-- Extraindo dados da tabela `resultado_serie`
--

/*
INSERT INTO `resultado_serie` (`id`, `id_serie`, `id_user`, `id_perg`, `id_resp`, `resultado_valor`) VALUES
(1, 1, 2, 4, 16, 0);*/
...
/*
ALTER TABLE `tabela2`
  ADD CONSTRAINT `tabela2_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `tabela1` (`id_cliente`) ON DELETE CASCADE;
COMMIT;
*/
...
CREATE DATABASE IF NOT EXISTS `sql7830939` DEFAULT CHARACTER SET utf8mb4;
USE `hsdcpt_myquiz`;
--
-- Estrutura da tabela `init_jogo`
--
